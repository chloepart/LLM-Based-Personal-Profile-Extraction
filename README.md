...
Please download the data from [this link](https://zenodo.org/records/14737200). 
...
* A script to download the Court dataset used in our evaluation.

Note that the other three datasets, i.e., Professor, Celebrity, and Physician, are only shared per request. Please contact us if you are interesed. 
